...
import pl.wozniakbartlomiej.receipt.Adapters.ReceiptsAdapter;

public class EventReceiptsActivity extends AppCompatActivity implements IServiceHelper {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_event_receipts);
        initSession();
        getExtrasFromIntent();
        assignViewElements();
    ...
    public void getReceipts() {
        asyncTask = new ReceiptServiceHelper(EventReceiptsActivity.this);
